    ...
    <div id="audit-reports-view" className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 text-xs font-bold rounded-xl shadow flex items-center gap-1.5 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-3">
          <div>
            ...
            <h4 className="font-bold text-white text-sm mt-0.5">Complete Staff Master Report</h4>
          ...
          <button
            ...
            className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-teal-300 font-bold rounded-xl flex items-center justify-center gap-1.5 transition-colors"
          >
        ...
        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-3">
          <div>
            ...
            <h4 className="font-bold text-white text-sm mt-0.5">GPS & Anti-Spoofing Audit</h4>
            <p className="text-slate-400 text-[11px] mt-1">
          ...
          <button
            ...
            className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-blue-300 font-bold rounded-xl flex items-center justify-center gap-1.5 transition-colors"
          >
            <Download className="w-3.5 h-3.5" />
            <span>Export CSV</span>
          </button>
        ...
        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-3">
          <div>
            ...
            <h4 className="font-bold text-white text-sm mt-0.5">Bank Advice & Tax Ledger</h4>
            <p className="text-slate-400 text-[11px] mt-1">
          ...
          <button
            onClick={handleExportAudit}
            className="w-full py-2 bg-slate-800 hover:bg-slate-700 text-emerald-300 font-bold rounded-xl flex items-center justify-center gap-1.5 transition-colors"
          >
            <Download className="w-3.5 h-3.5" />
            <span>Export CSV</span>
          </button>
              ...
              {filteredLogs.map((log) => (
                <tr key={log.id} className="hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="p-3">
                    ...
                    <div className="font-semibold text-slate-200 mt-1">{log.action}</div>
                  </td>

                  <td className="p-3 text-slate-300 max-w-[280px]">{log.details}</td>
