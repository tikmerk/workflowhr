              ...
              {filteredLeaves.map((l) => (
                <tr key={l.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="p-3">
                    ...
                    <div className="text-[10px] text-slate-500 dark:text-slate-400">{l.departmentName}</div>
                  </td>
                  ...
                  <td className="p-3">
                    ...
                    <div className="text-[10px] text-teal-700 dark:text-teal-400 font-semibold">{l.totalDays} Total Days</div>
                  </td>

                  <td className="p-3 max-w-[220px] truncate text-slate-600 dark:text-slate-300" title={l.reason}>
                    "{l.reason}"
                  </td>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 w-full max-w-md text-slate-900 dark:text-slate-100 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
              <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                <CalendarCheck className="w-5 h-5 text-teal-600 dark:text-teal-400" /> Review Leave Application
              </h3>
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 space-y-2 text-xs">
              ...
              <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                <span className="text-slate-500 dark:text-slate-400 block mb-0.5">Applicant Reason:</span>
                <p className="text-slate-700 dark:text-slate-200 italic font-sans">"{reviewingLeave.reason}"</p>
              </div>
            </div>

            <div className="space-y-1 text-xs">
              <label className="block text-slate-600 dark:text-slate-400 font-medium">HR Remarks / Approval Notes</label>
              <textarea
                rows={2}
                value={hrComments}
